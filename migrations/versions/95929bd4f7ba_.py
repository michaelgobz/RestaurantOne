...
Revision ID: 95929bd4f7ba
Revises: dc2f2e3dd8df
Create Date: 2023-03-24 11:08:04.837779
...
revision = '95929bd4f7ba'
down_revision = 'dc2f2e3dd8df'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('shipment_method', sa.String(length=255), nullable=False),
