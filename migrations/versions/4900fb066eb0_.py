...
Revision ID: 4900fb066eb0
Revises: 2bf617c87cc8
Create Date: 2023-03-24 17:53:07.817333
...
revision = '4900fb066eb0'
down_revision = '2bf617c87cc8'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['token_id'], ['verification_tokens.id'], use_alter=True),
    sa.PrimaryKeyConstraint('id')
    )
